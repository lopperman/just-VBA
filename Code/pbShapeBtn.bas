...
Public Function BuildShapeBtn(ws As Worksheet, shpName As String, shpCaption As String, rowPos As Long, colPos As Long, _
    ...
    Optional fontSize As Long = 14, Optional fontBold As Boolean = True, Optional fontUnderLine As Boolean = False, Optional shpPlacement As XlPlacement = XlPlacement.xlFreeFloating, Optional forceWidth As Variant) As Shape
...
Public Function DEVSHP() As Shape
    If Not IsDEV Then Exit Function
    If TypeName(Selection) = "Rectangle" Then
        Set DEVSHP = Selection.Parent.Shapes(Selection.Name)
    End If
End Function
...
Public Function AddPrimaryNavigation(ws As Worksheet)
    ...
    If Not sheetGraphic Is Nothing Then
        ...
        newTop = CLng(((3 * (BTN_UNIT_HEIGHT + BTN_PADDING)) / 2) - 25)
